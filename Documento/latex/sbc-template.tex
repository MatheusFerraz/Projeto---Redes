...
O trabalho apresenta como resultado uma aplicação, desenvolvida para android, que por meio de wifi direct realiza a transferência de arquivos entre dois dispositivos por meio de rede \textit{Peer-to-Peer}.

\section{Trabalhos futuros}

Em seu estado atual a aplicação desenvoldida tem algumas limitações, dentro dos trabalho futuros apresentamos algumas melhorias para a mesma.

\begin{itemize}

\item Troca do estado de servidor para cliente de forma automática.
\item Transferência de multiplos arquivos de uma única vez.
