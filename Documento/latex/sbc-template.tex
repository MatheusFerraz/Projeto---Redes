...
implementadas duas classes que herdam da classe BroadcastReceiver, sendo a \textit{WiFiClientBroadcastReceiver} e a
\textit{WiFiServerBroadcastReceiver}.
...
O trabalho apresenta como resultado uma aplicação, desenvolvida para android, que por meio de \textit{wifi direct} realiza a transferência de arquivos entre dois dispositivos por meio de rede \textit{Peer-to-Peer}.
